...
import br.com.entidade.ManterCardapio;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (idEstabelecimentoStr != null && !idEstabelecimentoStr.isEmpty()) {
                int idEstabelecimento = Integer.parseInt(idEstabelecimentoStr);
                ManterCardapio manterCardapio = new ManterCardapio();

                try {
                    ArrayList<Prato> pratos = manterCardapio.consultarPratosPorEstabelecimento(idEstabelecimento);
                    request.setAttribute("pratos", pratos);
                } catch (Exception e) {
                    request.setAttribute("erro", "Erro ao buscar os pratos: " + e.getMessage());
                }
            }
